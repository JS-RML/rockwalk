...
class robot_control:
    ...
    def follow_target_pose(self, data):
        ...
        try:
            ...
            #self._group.plan()
            self._group.execute(self._group.plan())
...
if __name__ == '__main__':
    rospy.init_node("kong_ur10", anonymous=True)
    ...
    kong_ur10.set_accel_scaling(0.4)


    rospy.loginfo("Subscribing to Pose Topic")
    rospy.Subscriber(topic, PoseStamped, kong_ur10.follow_target_pose) # Tracks Effector Here
