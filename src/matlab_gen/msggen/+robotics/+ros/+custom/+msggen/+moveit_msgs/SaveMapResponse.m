classdef SaveMapResponse < robotics.ros.Message
    ...
    methods
        function obj = SaveMapResponse(msg)
            %SaveMapResponse Construct the message object SaveMapResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SaveMapResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.SaveMapResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.SaveMapResponse;
            obj.reload(strObj);
        end
    end
end
