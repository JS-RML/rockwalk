classdef LoadMapRequest < robotics.ros.Message
    ...
    methods
        function obj = LoadMapRequest(msg)
            %LoadMapRequest Construct the message object LoadMapRequest
        ...
        function set.Filename(obj, filename)
            ...
            validateattributes(filename, {'char'}, {}, 'LoadMapRequest', 'Filename');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.LoadMapRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.LoadMapRequest;
            obj.reload(strObj);
        end
    end
end
