classdef PickupActionGoal < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '9e12196da542c9a26bbc43e9655a1906' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        MoveitMsgsPickupGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('moveit_msgs/PickupGoal') % Dispatch to MATLAB class for message type moveit_msgs/PickupGoal
    ...
    methods
        function obj = PickupActionGoal(msg)
            %PickupActionGoal Construct the message object PickupActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'PickupActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'PickupActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.MoveitMsgsPickupGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.MoveitMsgsPickupGoalClass}, {'nonempty', 'scalar'}, 'PickupActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.MoveitMsgsPickupGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.PickupActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.PickupActionGoal;
            obj.reload(strObj);
        end
    end
end
