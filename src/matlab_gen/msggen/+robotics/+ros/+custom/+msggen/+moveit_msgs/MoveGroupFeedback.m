classdef MoveGroupFeedback < robotics.ros.Message
    ...
    methods
        function obj = MoveGroupFeedback(msg)
            %MoveGroupFeedback Construct the message object MoveGroupFeedback
        ...
        function set.State(obj, state)
            ...
            validateattributes(state, {'char'}, {}, 'MoveGroupFeedback', 'State');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.MoveGroupFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.MoveGroupFeedback;
            obj.reload(strObj);
        end
    end
end
