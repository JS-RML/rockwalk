classdef LoadMapResponse < robotics.ros.Message
    ...
    methods
        function obj = LoadMapResponse(msg)
            %LoadMapResponse Construct the message object LoadMapResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'LoadMapResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.LoadMapResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.LoadMapResponse;
            obj.reload(strObj);
        end
    end
end
