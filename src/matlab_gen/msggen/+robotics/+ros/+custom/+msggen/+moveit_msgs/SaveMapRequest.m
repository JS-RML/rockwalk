classdef SaveMapRequest < robotics.ros.Message
    ...
    methods
        function obj = SaveMapRequest(msg)
            %SaveMapRequest Construct the message object SaveMapRequest
        ...
        function set.Filename(obj, filename)
            ...
            validateattributes(filename, {'char'}, {}, 'SaveMapRequest', 'Filename');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.SaveMapRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.SaveMapRequest;
            obj.reload(strObj);
        end
    end
end
