classdef PlaceActionGoal < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'facadaee390f685ed5e693ac12f5aa3d' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        MoveitMsgsPlaceGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('moveit_msgs/PlaceGoal') % Dispatch to MATLAB class for message type moveit_msgs/PlaceGoal
    ...
    methods
        function obj = PlaceActionGoal(msg)
            %PlaceActionGoal Construct the message object PlaceActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'PlaceActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'PlaceActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.MoveitMsgsPlaceGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.MoveitMsgsPlaceGoalClass}, {'nonempty', 'scalar'}, 'PlaceActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.MoveitMsgsPlaceGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.PlaceActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.PlaceActionGoal;
            obj.reload(strObj);
        end
    end
end
