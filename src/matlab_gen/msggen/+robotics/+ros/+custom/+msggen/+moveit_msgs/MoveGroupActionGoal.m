classdef MoveGroupActionGoal < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '5a63f1e432efa5831f25bdbf4067e372' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        MoveitMsgsMoveGroupGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('moveit_msgs/MoveGroupGoal') % Dispatch to MATLAB class for message type moveit_msgs/MoveGroupGoal
    ...
    methods
        function obj = MoveGroupActionGoal(msg)
            %MoveGroupActionGoal Construct the message object MoveGroupActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveGroupActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'MoveGroupActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.MoveitMsgsMoveGroupGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.MoveitMsgsMoveGroupGoalClass}, {'nonempty', 'scalar'}, 'MoveGroupActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.MoveitMsgsMoveGroupGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.moveit_msgs.MoveGroupActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.moveit_msgs.MoveGroupActionGoal;
            obj.reload(strObj);
        end
    end
end
