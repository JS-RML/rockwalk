classdef SetIOResponse < robotics.ros.Message
    %SetIOResponse MATLAB implementation of ur_msgs/SetIOResponse
    ...
    properties (Constant)
        MessageType = 'ur_msgs/SetIOResponse' % The ROS message type
    end
    ...
    methods
        function obj = SetIOResponse(msg)
            %SetIOResponse Construct the message object SetIOResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SetIOResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.ur_msgs.SetIOResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.ur_msgs.SetIOResponse;
            obj.reload(strObj);
        end
    end
end
