classdef DualArmEff < robotics.ros.Message
    %DualArmEff MATLAB implementation of ur_msgs/DualArmEff
    ...
    properties (Constant)
        MessageType = 'ur_msgs/DualArmEff' % The ROS message type
    end
    ...
    methods
        function obj = DualArmEff(msg)
            %DualArmEff Construct the message object DualArmEff
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'DualArmEff', 'Header');
        ...
        function set.HongTargetPose(obj, hongtargetpose)
            ...
            validateattributes(hongtargetpose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'DualArmEff', 'HongTargetPose');
        ...
        function set.KongTargetPose(obj, kongtargetpose)
            ...
            validateattributes(kongtargetpose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'DualArmEff', 'KongTargetPose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.ur_msgs.DualArmEff.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.ur_msgs.DualArmEff;
            obj.reload(strObj);
        end
    end
end
