classdef SetPayloadResponse < robotics.ros.Message
    %SetPayloadResponse MATLAB implementation of ur_msgs/SetPayloadResponse
    ...
    properties (Constant)
        MessageType = 'ur_msgs/SetPayloadResponse' % The ROS message type
    end
    ...
    methods
        function obj = SetPayloadResponse(msg)
            %SetPayloadResponse Construct the message object SetPayloadResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SetPayloadResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.ur_msgs.SetPayloadResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.ur_msgs.SetPayloadResponse;
            obj.reload(strObj);
        end
    end
end
