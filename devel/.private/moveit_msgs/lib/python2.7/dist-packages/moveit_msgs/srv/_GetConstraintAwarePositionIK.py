    ...
    try:
      ...
      for val1 in self.ik_request.robot_state.attached_collision_objects:
        ...
        for val3 in _v149.plane_poses:
          ...
          _x = _v158
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v149.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v160 = _v159.header
        buff.write(_get_struct_I().pack(_v160.seq))
        _v161 = _v160.stamp
        _x = _v161
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v160.frame_id
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        for val3 in _v291.plane_poses:
          ...
          _x = _v300
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v291.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v302 = _v301.header
        buff.write(_get_struct_I().pack(_v302.seq))
        _v303 = _v302.stamp
        _x = _v303
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v302.frame_id
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v311.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        _v331 = val1.object
        _v332 = _v331.header
        buff.write(_get_struct_I().pack(_v332.seq))
        _v333 = _v332.stamp
        _x = _v333
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v332.frame_id
        ...
        for val3 in _v331.plane_poses:
          ...
          _x = _v340
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v331.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v351.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
