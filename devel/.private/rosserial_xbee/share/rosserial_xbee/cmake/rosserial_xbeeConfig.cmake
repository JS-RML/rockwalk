...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/nazir/ws_moveit/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/nazir/ws_moveit/devel/.private/rosserial_xbee)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/nazir/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nazir/ws_moveit/src/rosserial/rosserial_xbee/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nazir/ws_moveit/devel/.private/rosserial_xbee/lib;/home/nazir/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
