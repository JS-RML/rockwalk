...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /home/nazir/ws_moveit/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /home/nazir/ws_moveit/devel/.private/geometric_shapes)
  ...
  set(geometric_shapes_INSTALL_PREFIX /home/nazir/ws_moveit/install)
...
if(NOT "/home/nazir/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/home/nazir/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/kinetic/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nazir/ws_moveit/src/geometric_shapes/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Isaac I. Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nazir/ws_moveit/devel/.private/geometric_shapes/lib;/home/nazir/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
