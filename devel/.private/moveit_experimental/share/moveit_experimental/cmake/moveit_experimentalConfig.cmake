...
if("TRUE" STREQUAL "TRUE")
  set(moveit_experimental_SOURCE_PREFIX /home/nazir/ws_moveit/src/moveit/moveit_experimental)
  set(moveit_experimental_DEVEL_PREFIX /home/nazir/ws_moveit/devel/.private/moveit_experimental)
  ...
  set(moveit_experimental_INSTALL_PREFIX /home/nazir/ws_moveit/install)
...
if(NOT "/home/nazir/ws_moveit/devel/.private/moveit_experimental/include;/home/nazir/ws_moveit/src/moveit/moveit_experimental/collision_distance_field/include;/opt/ros/kinetic/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(moveit_experimental_INCLUDE_DIRS "")
  set(_include_dirs "/home/nazir/ws_moveit/devel/.private/moveit_experimental/include;/home/nazir/ws_moveit/src/moveit/moveit_experimental/collision_distance_field/include;/opt/ros/kinetic/include;/usr/include/eigen3;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nazir/ws_moveit/src/moveit/moveit_experimental/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nazir/ws_moveit/devel/.private/moveit_experimental/lib;/home/nazir/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
